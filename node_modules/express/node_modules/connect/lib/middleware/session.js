...
// ===
  ...
  return function session(req, res, next) {
    ...
    if(req.ConnectSidObj) {
      rawCookie = req.ConnectSidObj[key];
    }
    // req.cookies -> { 'connect.sid': 's:rAaTy9oxAOCBsaqCSv39BEhQ.1N/fwixYMYe1hQoHZ3gy4HRzdanEVeUt+Z2
// CIb/I+0QITZPfXVn9LtKcli7Btkj/dJymoPQ015QTNeo0ZM2E2Q' }
    ...
    if (!unsignedCookie && rawCookie) {
      ...
      //unsignedCookie -> rAaTy9oxAOCBsaqCSv39BEhQ
    }
    // set-cookie
