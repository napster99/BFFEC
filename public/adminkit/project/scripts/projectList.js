      ...
      view: function() {
        ...
        oPage.data = avalon.define('page', function(vm) {  
          ...
          vm.searchBtn = function() {
            oPage.doAjax(window.serverUrl + '/data/project/list', options1, callback1);
          };
          ...
          vm.deleteFun = function() {
            ...
            bootbox.confirm('确定要删除此项目吗？', function(result) {
              ...
              if(result) {
                ...
                oPage.doAjax(window.serverUrl + '/data/project/del', options3, callback3);             
              }
            });
          };
          ...
          vm.applyFun = function() {
            ...
            bootbox.confirm('确定要提交结项吗？', function(result) {
              ...
              if(result) {
                ...
                oPage.doAjax(window.serverUrl + '/data/project/list', options4, callback4);
              }
            });
          };
        ...
        var callback1 = function(list) {
          ...
          ui.$paginate.data('pagination', null).pagination({
            ...
            , onPageChange: function(page, jumpUrl){
              ...
              oPage.doAjax(window.serverUrl + '/data/project/list', options2, callback2);
            }
          });
        };
        // 请求列表数据
